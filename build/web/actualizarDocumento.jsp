...
<div class="user" >
    ...
    <form class="form" action="ActualizarDocumento" method="post">
        ...
        <div class="form__group">
            <input name="inicial" readonly type="text" value="<%=rs.getString(2)%>" placeholder="Inicial" class="form__input" />
        </div>
        <br>
        <div class="form__group">
            <input name="nombreDocumento" type="text" value="<%=rs.getString(3)%>" placeholder="nombreDoc" class="form__input" />

        </div>
        <br>
        <div class="form__group">
            <select name="estadoTipoDocumento" class="form__input">  
